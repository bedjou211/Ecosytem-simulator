...
baniere = pygame.image.load('images/titre.png')
stat = pygame.image.load('images/stat.png')
infos = pygame.image.load('images/infos.png')
lion = pygame.image.load('images/lion.png')
mouton = pygame.image.load('images/mouton.png')
lion = pygame.image.load('images/lion.png')
plus = pygame.image.load("images/plus.png")
moins = pygame.image.load("images/moins.png")
