...
class Monde_pygame(Monde):
    ...
    def interaction(self):
        ...
        self.boutons = [plus1,plus2,plus3,moins1]
    ...
    #mise_jour d'un animal en cours de deplacement
    ...
    #déplacement des animaux pour manger
    def deplace_pour_boire(self,animal,a,b):
        ...
        while not(x == a and y == b):           
            ...
            self.points_eau_.draw(self.screen)
            pygame.display.flip()
