...
class Plante(pygame.sprite.Sprite):
    def __init__(self,nom_plante,taille,x,y):
        ...
        self.position = (x,y)
        self.image = pygame.image.load('images/vert.png')
...
class Herbivore(Animal):
    def __init__(self,nom_herbivore,degre_de_faim,degre_de_soif,sexe,x,y):
        ...
        self.image = pygame.image.load('images/blanc.png')
        self.rect = self.image.get_rect()
        x_,y_ = positions[(x,y)]
        self.rect = self.rect.move(x_,y_)
...
class Carnivore(Animal):
    def __init__(self,nom_carnivore,degre_de_faim,degre_de_soif,sexe,x,y):
        ...
        self.image = pygame.image.load('images/rouge.png')
        x_, y_ = positions[(x,y)]
        self.rect = self.image.get_rect()
        self.rect = self.rect.move(x_,y_)
    ...
    def peut_dupliquer(self):         
        return self.niveau_energie >= 320 and self.sexe == 1 and self.age >= 5   #un carnivore se dupliquera si son niveau d'energie est supérieur 320
...
class Eau(pygame.sprite.Sprite):
    def __init__(self,x,y):
        pygame.sprite.Sprite.__init__(self)
        self.position = (x,y)
        self.image = pygame.image.load('images/bleu.png')
        self.rect = self.image.get_rect()
        x_,y_ = positions[(x,y)]
        self.rect = self.rect.move(x_,y_)
